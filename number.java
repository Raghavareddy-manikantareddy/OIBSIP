...
//        lblpic.setIcon(new ImageIcon("IMG_20210615_215300"));
...
//                a.setFont(new Font("tunga",Font.BOLD,24));
            }
            else if(a>rand)
            {
